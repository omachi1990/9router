...
export default {
  ...
  models: [
    ...
    { id: "gemini-3.6-flash", name: "Gemini 3.6 Flash", thinking: false },
    { id: "gemini-3.5-flash-high", name: "Gemini 3.5 Flash (High)" },
    { id: "gemini-3.5-flash-lite-agent", name: "Gemini 3.5 Flash-Lite (High)" },
    { id: "gemini-3.5-flash-lite", name: "Gemini 3.5 Flash-Lite", thinking: false },
    { id: "gemini-3-flash-agent", name: "Gemini 3.5 Flash (High)" },
    { id: "gemini-3.5-flash-low", name: "Gemini 3.5 Flash (Medium)" },
    { id: "gemini-3.5-flash-extra-low", name: "Gemini 3.5 Flash (Low)" },
    { id: "gemini-pro-agent", name: "Gemini 3.1 Pro (High)" },
    { id: "gemini-3.1-pro-low", name: "Gemini 3.1 Pro (Low)" },
    { id: "gemini-3.1-pro", name: "Gemini 3.1 Pro", thinking: false },
